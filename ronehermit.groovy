...
OWLOntologyLoaderConfiguration config = new OWLOntologyLoaderConfiguration();
  ...
  oReasoner.precomputeInferences(InferenceType.CLASS_HIERARCHY, InferenceType.CLASS_ASSERTIONS, InferenceType.DATA_PROPERTY_ASSERTIONS, InferenceType.
DISJOINT_CLASSES, InferenceType.OBJECT_PROPERTY_HIERARCHY);

  println "[UNMIREOT] Unsatisfiable classes: " + (oReasoner.getUnsatisfiableClasses().size() - 1)
